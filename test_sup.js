...
// From the screenshot, the query looks like:
// ?select=*%2Csecoes%3Atemplate_secoes(...campos%3Atemplate_campos(...opcoes_lista%3Atemplate_campo_opcoes(*)))
// &secoes.order=ordem.asc&campos.order=ordem.asc&opcoes_lista.order=ordem.asc

// Build the exact query URL that supabase-js generated
const query = new URLSearchParams({
  ...
  'campos.order': 'ordem.asc',
  'opcoes_lista.order': 'ordem.asc'
});
